...
function av_group_increasing_func(){
...
<div class="av-admin-message success">مقدار <strong><?php echo human_time_diff($_GET['added']+time(),time()); ?></strong> به حساب های ویژه کاربران اضافه شد.</div>
<?php } ?>
...
<?php } ?>
	<h3>افزایش اعتبار تمامی کاربران</h3>
	<form method="post" action="">
		<table style="width:100%;">
			<tr>
				<td>واحد اضافه شدن را انتخاب کنید.</td>
				<td>
			...
			<tr>
				...
				<td>
					<input type="text" name="vip_charge_value" />
				</td>
			</tr>
			<tr>
